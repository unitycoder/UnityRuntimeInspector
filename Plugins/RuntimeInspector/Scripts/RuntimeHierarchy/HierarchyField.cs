...
#pragma warning restore 0649
        ...
        public void Initialize(RuntimeHierarchy hierarchy)
        {
            ...
            if (hierarchy.ShowTooltips) clickListener.gameObject.AddComponent<TooltipArea>().Initialize(hierarchy.TooltipListener, this);

            expandToggle.PointerClick += (eventData) => ToggleExpandedState();
            clickListener.PointerClick += (eventData) => OnClick(eventData);

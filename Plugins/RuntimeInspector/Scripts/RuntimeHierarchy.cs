...
#pragma warning disable 0649
        ...
        [Header("ContextMenu")]
        [SerializeField]
        private ContextMenuSystem contextMenu;
...
#pragma warning restore 0414
        ...
        void IListViewAdapter.OnItemClicked(RecycledListItem item, PointerEventData eventData)
        {
            HierarchyField drawer = (HierarchyField)item;
            ...
            {
                //Debug.Log("Right clicked item: " + drawer.Data.Name);
                Vector2 mousePos = Input.mousePosition;
                contextMenu.Show(mousePos, drawer.Data.BoundTransform);
                return;
            }
        ...
        private void OnCurrentSelectionChanged(bool dontRaiseEvent = false)
        {
            ...
            try
            {
                ...
                if (highlightSystem) highlightSystem.Highlight(m_currentSelection);
